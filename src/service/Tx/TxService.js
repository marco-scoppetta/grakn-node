...
/**
 * This module executes the methods provided by the gRPC that are defined
...
TxService.prototype.getSubConcepts = function (id) {
    ...
    return this.communicator.send(txRequest)
        .then(grpcConceptResponse => consumeConceptIterator(grpcConceptResponse, this));
};
...
TxService.prototype.getRelationshipTypesThatRelateRole = function (id) {
    ...
    return this.communicator.send(txRequest)
        .then(response => consumeConceptIterator(response, this));
}
 ...
 */
async function consumeConceptIterator(grpcResponse, txService) {
    ...
    const iterator = new GrpcIterator.GrpcConceptIterator(iteratorId, txService.communicator);
    const concepts = [];
...
function getAttributeValueFromResponse(resp) {
